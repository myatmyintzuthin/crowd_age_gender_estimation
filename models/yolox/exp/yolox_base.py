...
class Exp(BaseExp):
    ...
    def get_model(self):
        from models.yolox.models import YOLOX, YOLOPAFPN, YOLOXHead
    ...
    def get_dataset(self, cache: bool = False, cache_type: str = "ram"):
        ...
        """
        from models.yolox.data import COCODataset, TrainTransform
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False, cache_img: str = None):
        ...
        from models.yolox.utils import wait_for_the_master
